  ...
  return (
    <main>
      ...
      <div className='container'>
        ...
        <p className='text font-400 font-grey heading-padded'>EDUCATION</p>
      ...
      <div className='container'>
        <div className='program-container'>
        <p className='text font-400 font-grey heading-padded' style={{textTransform: "capitalize"}}>FEATURED WORKS</p>
